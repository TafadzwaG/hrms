...
const RecruitmentReportController = { candidateListings, vacanciesByCompany, applicationsByVacancy, paymentSummary, listingRevenue, employerActivity, candidatesByProfession, pendingListings }

export default RecruitmentReportController