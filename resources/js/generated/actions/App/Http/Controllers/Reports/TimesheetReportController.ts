...
const TimesheetReportController = { register, byStatus, pendingApprovals, overtimeByEmployee, overtimeSummary, totalMinutesByPeriod, exceptionTimesheets }

export default TimesheetReportController