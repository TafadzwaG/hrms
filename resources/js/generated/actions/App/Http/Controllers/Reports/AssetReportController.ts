...
const AssetReportController = { register, byCategory, byStatus, byLocation, byCondition, warrantyExpiring, assignments, maintenance, depreciation }

export default AssetReportController