 ...
 * @see app/Http/Controllers/EmployeeController.php:922
 ...
 * @see app/Http/Controllers/EmployeeController.php:927
 ...
 * @see app/Http/Controllers/EmployeeController.php:985
...
/**
* @see \App\Http\Controllers\EmployeeController::exportSelected
 * @see app/Http/Controllers/EmployeeController.php:313
 * @route '/employees/export-selected'
 */
export const exportSelected = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: exportSelected.url(options),
    method: 'post',
})

exportSelected.definition = {
    methods: ["post"],
    url: '/employees/export-selected',
} satisfies RouteDefinition<["post"]>
 ...
 * @route '/employees/export-selected'
 */
exportSelected.url = (options?: RouteQueryOptions) => {
    return exportSelected.definition.url + queryParams(options)
}
 ...
 * @route '/employees/export-selected'
 */
exportSelected.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: exportSelected.url(options),
    method: 'post',
})
 ...
 * @route '/employees/export-selected'
 */
    const exportSelectedForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: exportSelected.url(options),
        method: 'post',
    })
 ...
 * @route '/employees/export-selected'
 */
        exportSelectedForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: exportSelected.url(options),
            method: 'post',
        })
    
    exportSelected.form = exportSelectedForm
/**
* @see \App\Http\Controllers\EmployeeController::exportPdf
 * @see app/Http/Controllers/EmployeeController.php:278
 * @route '/employees/{employee}/pdf'
 */
export const exportPdf = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/employees/{employee}/pdf'
 */
exportPdf.url = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
 ...
 * @route '/employees/{employee}/pdf'
 */
exportPdf.get = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: exportPdf.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/employees/{employee}/pdf'
 */
exportPdf.head = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: exportPdf.url(args, options),
    method: 'head',
})
 ...
 * @route '/employees/{employee}/pdf'
 */
    const exportPdfForm = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/employees/{employee}/pdf'
 */
        exportPdfForm.get = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: exportPdf.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/employees/{employee}/pdf'
 */
        exportPdfForm.head = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @see app/Http/Controllers/EmployeeController.php:859
 ...
 * @see app/Http/Controllers/EmployeeController.php:867
 ...
 * @see app/Http/Controllers/EmployeeController.php:876
 * @route '/employees/{employee}/skills/{skill}'
 */
 ...
 * @see app/Http/Controllers/EmployeeController.php:896
 ...
 * @see app/Http/Controllers/EmployeeController.php:904
 ...
 * @see app/Http/Controllers/EmployeeController.php:913
 * @route '/employees/{employee}/kpis/{kpi}'
 */
 ...
 * @see app/Http/Controllers/EmployeeController.php:429
 * @route '/employees'
 */
 ...
 * @see app/Http/Controllers/EmployeeController.php:450
 ...
 * @see app/Http/Controllers/EmployeeController.php:639
 ...
 * @see app/Http/Controllers/EmployeeController.php:684
 * @route '/employees/{employee}'
 */
 ...
 * @see app/Http/Controllers/EmployeeController.php:706
 * @route '/employees/{employee}'
 */
