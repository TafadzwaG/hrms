...
/**
* @see \App\Http\Controllers\LocationController::downloadTemplate
...
const LocationController = { exportMethod, upload, downloadTemplate, importMethod, index, create, store, show, edit, update, destroy, export: exportMethod, import: importMethod }
