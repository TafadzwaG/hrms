...
/**
* @see \App\Http\Controllers\Employer\VacanciesController::updateStatus
 * @see app/Http/Controllers/Employer/VacanciesController.php:168
 * @route '/employer/vacancies/{vacancy}/status'
 */
export const updateStatus = (args: { vacancy: string | number } | [vacancy: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
 ...
 * @route '/employer/vacancies/{vacancy}/status'
 */
updateStatus.url = (args: { vacancy: string | number } | [vacancy: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { vacancy: args }
    }
 ...
 * @route '/employer/vacancies/{vacancy}/status'
 */
updateStatus.patch = (args: { vacancy: string | number } | [vacancy: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: updateStatus.url(args, options),
    method: 'patch',
})
 ...
 * @route '/employer/vacancies/{vacancy}/status'
 */
    const updateStatusForm = (args: { vacancy: string | number } | [vacancy: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/employer/vacancies/{vacancy}/status'
 */
        updateStatusForm.patch = (args: { vacancy: string | number } | [vacancy: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: updateStatus.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
...
const VacanciesController = { index, create, store, show, edit, update, updateStatus, destroy }
