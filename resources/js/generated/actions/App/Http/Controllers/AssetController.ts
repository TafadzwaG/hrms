 ...
 * @see app/Http/Controllers/AssetController.php:25
 * @route '/assets'
 */
 ...
 * @see app/Http/Controllers/AssetController.php:146
 * @route '/assets'
 */
 ...
 * @see app/Http/Controllers/AssetController.php:181
 * @route '/assets/{asset}'
 */
 ...
 * @see app/Http/Controllers/AssetController.php:214
 ...
 * @see app/Http/Controllers/AssetController.php:224
 * @route '/assets/{asset}'
 */
 ...
 * @see app/Http/Controllers/AssetController.php:261
 * @route '/assets/{asset}'
 */
 ...
 * @see app/Http/Controllers/AssetController.php:271
 ...
 * @see app/Http/Controllers/AssetController.php:318
...
export const returnAsset = (args: { asset: number | { id: number } } | [asset: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: returnAsset.url(args, options),
    method: 'post',
})

returnAsset.definition = {
    methods: ["post"],
...
returnAsset.url = (args: { asset: number | { id: number } } | [asset: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    return returnAsset.definition.url
            .replace('{asset}', parsedArgs.asset.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 */
    const returnAssetForm = (args: { asset: number | { id: number } } | [asset: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: returnAsset.url(args, options),
        method: 'post',
    })
 ...
 * @see app/Http/Controllers/AssetController.php:364
 ...
 * @see app/Http/Controllers/AssetController.php:401
 ...
 * @see app/Http/Controllers/AssetController.php:423
 ...
 * @see app/Http/Controllers/AssetController.php:441
...
const AssetController = { index, create, store, show, edit, update, destroy, assign, returnAsset, dispose, storeDocument, downloadDocument, destroyDocument }
