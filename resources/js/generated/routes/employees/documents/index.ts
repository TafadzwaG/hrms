...
/**
* @see \App\Http\Controllers\EmployeeDocumentController::upload
 * @see app/Http/Controllers/EmployeeDocumentController.php:46
 * @route '/employees/{employee}/documents/upload'
 */
export const upload = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/employees/{employee}/documents/upload'
 */
upload.url = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { employee: args }
    }
 ...
 * @route '/employees/{employee}/documents/upload'
 */
upload.get = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: upload.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/employees/{employee}/documents/upload'
 */
upload.head = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: upload.url(args, options),
    method: 'head',
})
 ...
 * @route '/employees/{employee}/documents/upload'
 */
    const uploadForm = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/employees/{employee}/documents/upload'
 */
        uploadForm.get = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: upload.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/employees/{employee}/documents/upload'
 */
        uploadForm.head = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
