 ...
 */
export const sendPasswordResetLink = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: sendPasswordResetLink.url(args, options),
    method: 'post',
})
 ...
 * @route '/users/{user}/send-password-reset-link'
 */
sendPasswordResetLink.url = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    return sendPasswordResetLink.definition.url
 ...
 * @route '/users/{user}/send-password-reset-link'
 */
sendPasswordResetLink.post = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: sendPasswordResetLink.url(args, options),
    method: 'post',
})
 ...
 * @route '/users/{user}/send-password-reset-link'
 */
    const sendPasswordResetLinkForm = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: sendPasswordResetLink.url(args, options),
        method: 'post',
    })
 ...
 * @route '/users/{user}/send-password-reset-link'
 */
        sendPasswordResetLinkForm.post = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: sendPasswordResetLink.url(args, options),
            method: 'post',
        })
    
    sendPasswordResetLink.form = sendPasswordResetLinkForm
/**
