            ...
            <div className="w-full p-6 lg:p-10">
                ...
                <div className="mb-10">
                    ...
                    <p className="mt-2 text-lg text-muted-foreground">
                        Update classification and depreciation rules for{' '}
                ...
                >
                    ...
                    <div className="space-y-12 lg:col-span-8">
                        ...
                        <div className="rounded-xl border border-border bg-card p-8 shadow-sm">
                            <SectionHeader icon={Database} title="Basic Identity" />
                            <div className="grid gap-6 sm:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-bold">Category Code</label>
                                    <Input
                                        value={data.code}
                        ...
                        <div className="rounded-xl border border-border bg-card p-8 shadow-sm">
                            <SectionHeader icon={Calculator} title="Depreciation Logic" />
                            <div className="grid gap-6 sm:grid-cols-3">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setData('useful_life_years', e.target.value)
                                        }
                                        placeholder="5"
                                    />
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setData('depreciation_rate', e.target.value)
                                        }
                                        placeholder="20%"
                                    />
                        ...
                        <div className="rounded-xl border border-border bg-card p-8 shadow-sm">
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-bold">Internal Notes</label>
                                <Textarea
                        ...
                        <div className="rounded-xl border border-border bg-muted/30 p-8 shadow-sm">
                            ...
                            <div className="space-y-8">
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                                            Parent categories allow sub-categories to inherit
                                            depreciation rules and tax treatments.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                                            ...
                                            for consistent expense reports over time.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-sm font-bold">Valuation Impact</h4>
                                        <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                                            Useful life directly impacts your balance sheet. Shorter
                                            cycles increase monthly expenses.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-10 rounded-lg border border-orange-500/10 bg-orange-500/5 p-5">
                                <h4 className="text-sm font-bold text-orange-900">Need help?</h4>
                                <p className="mt-1 text-xs leading-relaxed text-orange-800/80">
                                    Refer to our asset management documentation for tax compliance
                                    guidelines.
                                </p>
                                <a
                                    href="#"
