...
export default function LearningCourseCreate() {
    const { statusOptions } = usePage().props as unknown as {
    ...
    // Helper to format status labels cleanly
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Create New Course', href: '#' },
            ]}
        >
            <Head title="Create Learning Course" />

            <div className="flex min-h-[calc(100vh-64px)] w-full flex-col bg-muted/10">
                {/* Removed max-w limit to span full screen */}
                <div className="w-full flex-1 p-4 md:p-8 lg:p-12">
                    ...
                    <div className="mb-10">
                        ...
                        <p className="mt-2 text-base text-muted-foreground">
                            Follow the steps below to configure your new course
                            curriculum.
                        </p>
                    </div>
                    ...
                    <form id="create-course-form" onSubmit={handleSubmit}>
                        ...
                        {currentStep === 1 && (
                            <div className="animate-in duration-500 fade-in slide-in-from-bottom-4">
                                {/* Increased max-w for larger screens since wrapper is full width */}
                ...
                {/* Sticky Bottom Actions - Full Width */}
