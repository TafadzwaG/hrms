...
export default function PerformanceReviewEdit() {
    const { review, employees, statusOptions } = usePage().props as unknown as {
        review: any;
        employees: Employee[];
    ...
    return (
        ...
        >
            <Head title={`Edit Review - ${review?.cycle_name}`} />
                ...
                <div className="w-full flex-1 p-4 md:p-8 lg:p-12">
                    <div className="mb-8">
                        ...
                        <p className="mt-2 text-base leading-relaxed text-muted-foreground">
                            Update the details of the selected organizational
                            review period.
                        </p>
                    </div>
                                    ...
                                    <CardContent className="space-y-6 p-4 md:p-6">
                                        ...
                                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:gap-8">
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <Input
                                                    ...
                                                    className={`h-11 bg-background text-base ${errors.rating ? 'border-destructive focus-visible:ring-destructive' : ''}`}
                                                />
                                                {errors.rating && (
                                                    <p className="text-xs font-medium text-destructive">
                                                        {errors.rating}
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <Textarea
                                                ...
                                                className="min-h-[160px] resize-none bg-background text-base"
                                            />
                                            {errors.comments && (
                                                <p className="text-xs font-medium text-destructive">
                                                    {errors.comments}
