    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Payslip', href: `/payroll/payslips/${payslip.id}` },
            ]}
        >
                ...
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    <div>
                        <div className="flex flex-wrap items-center gap-3">
                            <h1 className="text-3xl font-extrabold tracking-tight text-foreground">{payslip.employee.full_name}</h1>
                    ...
                    <Button asChild className="h-11 bg-foreground px-6 font-bold text-background">
                        <a href={payslip.download_url}>Download PDF</a>
                    </Button>
                </div>
