...
export default function AssetMaintenanceCreate() {
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        post(`/assets/${asset.id}/maintenance`, { preserveScroll: true });
    };
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'New Maintenance Record', href: '#' },
            ]}
        >
            <Head title={`New Maintenance - ${asset.name}`} />
