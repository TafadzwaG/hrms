...
export default function EditOrganization() {
    const { organization, statusOptions, timezones, summary } =
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Optional: Metrics Row (Kept from your original Edit.tsx, styled monochromatically) */}
                    ...
                    {[
                        ...
                        >
                            <CardContent className="p-6">
                                ...
                                <p className="mt-2 text-3xl font-extrabold tracking-tighter text-foreground">
                                    {value}
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="border-border bg-background shadow-sm">
                            <CardContent className="space-y-6 p-6">
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-border bg-muted text-muted-foreground">
                                        {form.data.logo_path ? (
                                            <img
                                                src={form.data.logo_path}
                                                alt="Logo"
                                        ...
                                        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                                            ...
                                            <div className="h-full space-y-2">
                                                ...
                                                <Input
                                                    ...
                                                    placeholder="https://..."
                                                    className="mb-2 h-11 bg-background text-sm shadow-sm"
                                                />
                                                <div className="flex h-full min-h-[100px] cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-border/60 bg-muted/5 p-6 text-center transition-colors hover:bg-muted/10">
