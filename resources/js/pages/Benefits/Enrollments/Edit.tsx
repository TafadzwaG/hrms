...
export default function EnrollmentEdit() {
    ...
    const { data, setData, errors, put, processing } = useForm({
        ...
        benefit_id: String(enrollment.benefit_id ?? ''),
        benefit_plan_id: enrollment.benefit_plan_id ? String(enrollment.benefit_plan_id) : '',
        status: enrollment.status ?? 'active',
        effective_date: enrollment.effective_date ?? '',
        end_date: enrollment.end_date ?? '',
        employee_contribution: enrollment.employee_contribution != null ? String(enrollment.employee_contribution) : '',
        employer_contribution: enrollment.employer_contribution != null ? String(enrollment.employer_contribution) : '',
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        put(`/benefit-enrollments/${enrollment.id}`, { preserveScroll: true });
    };
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: `#${enrollment.id}`, href: `/benefit-enrollments/${enrollment.id}` },
                { title: 'Edit' },
            ]}
        >
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                Update enrollment for {enrollment.employee.full_name}.
                            </p>
                        </div>
                    </div>
