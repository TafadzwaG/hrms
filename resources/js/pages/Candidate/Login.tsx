        ...
        <div className="flex min-h-screen flex-col items-center justify-center bg-slate-50 px-4 py-12 font-sans">
            ...
            <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
                <div className="mb-8 text-center">
                    ...
                    <p className="text-sm text-slate-500">Log in to manage your applications and profile</p>
                </div>

                {status ? (
                    <div className="mb-6 rounded-lg border border-emerald-100 bg-emerald-50 p-3 text-center text-sm font-medium text-emerald-700">
                        {status}
                    </div>
                ) : null}
                ...
                <form onSubmit={submit} className="flex flex-col gap-5">
                    ...
                    <div className="grid gap-2">
                        <div className="flex items-center justify-between">
                            ...
                            {canResetPassword ? (
                                <Link href="/candidate/forgot-password" className="text-xs font-medium text-slate-500 transition-colors hover:text-slate-900">
                                    Forgot password?
                                </Link>
                            ) : null}
                        </div>
                    ...
                    <Button type="submit" className="mt-2 w-full bg-slate-900 py-5 font-semibold text-white hover:bg-slate-800" disabled={processing}>
            ...
            <p className="mt-6 text-center text-sm text-slate-500">
                ...
                <Link href="/candidate/register" className="font-semibold text-slate-900 hover:underline">
