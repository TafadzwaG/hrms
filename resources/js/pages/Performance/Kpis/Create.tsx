                ...
                <div className="mb-6 flex flex-col gap-4 border-b pb-6 lg:flex-row lg:items-end lg:justify-between">
                    <div className="flex items-start gap-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div>
                                <h1 className="text-3xl font-semibold tracking-tight">New KPI</h1>
                                <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
                                    Create a KPI using the same structured layout as performance cycles.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <CardContent className="grid gap-6 md:grid-cols-2">
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <Textarea
                                        ...
                                        rows={6}
                                        placeholder="Describe how this KPI is measured, who owns it, and how it should be used."
                                    />
                        ...
                        <div className="space-y-6 xl:sticky xl:top-6">
                            ...
                            <Card className="bg-muted/20">
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Preview the KPI before saving it to the library.
                                    </CardDescription>
                                </CardHeader>
