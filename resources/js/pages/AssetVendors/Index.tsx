        ...
        >
            ...
            <div className="mx-auto w-full max-w-7xl space-y-6 p-4 md:p-6">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight">Asset Vendors</h1>
                    ...
                    <CardContent>
                        {vendors.data.length === 0 ? (
                            <div className="flex flex-col items-center justify-center py-12 text-center">
                                ...
                                <h3 className="mb-1 text-lg font-semibold">No vendors found</h3>
                                <p className="mb-4 text-sm text-muted-foreground">
                                    Create your first asset vendor.
                                </p>
                            </div>
                        ) : (
                                    ...
                                    <TableBody>
                                        {vendors.data.map((vendor) => (
                                            <TableRow key={vendor.id}>
                                                ...
                                                <TableCell>{vendor.assets_count}</TableCell>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            <strong>{vendorToDelete?.name}</strong>? This action cannot be undone.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
