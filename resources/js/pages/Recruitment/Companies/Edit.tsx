...
export default function CompanyEdit() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/company-profiles/${company.id}`);
    };
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: company.company_name, href: `/company-profiles/${company.id}` },
                { title: 'Edit' },
            ]}
        >
            ...
            <div className="w-full space-y-6 bg-white p-4 lg:p-8">
                <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                    <div className="space-y-1">
                        ...
                        <p className="text-lg text-zinc-500">
                            Update profile for {company.company_name}.
                        </p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="flex items-center justify-end gap-3">
                        ...
                        >
                            <Save className="mr-2 h-4 w-4" /> Update Company
                        </Button>
                    </div>
                </form>
            </div>
