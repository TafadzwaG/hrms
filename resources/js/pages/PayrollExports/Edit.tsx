...
export default function PayrollExportEdit() {
    const { module, record } = usePage().props as any;

    // Safely format dates for the HTML <input type="date"> which expects YYYY-MM-DD
    ...
    const handleSubmit = (e: React.FormEvent, forceStatus?: string) => {
        ...
        put(`${API}/${module?.slug || 'payroll-exports'}/${record.id}`, {
            preserveScroll: true,
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Edit Export', href: '#' },
            ]}
        >
            <Head title="Edit Payroll Export" />
            ...
            <div className="min-h-[calc(100vh-64px)] w-full bg-muted/10 p-4 md:p-6 lg:p-8">
                ...
                <div className="mb-8 max-w-3xl">
                    ...
                    <p className="mt-2 text-base leading-relaxed text-muted-foreground">
                        Modify an existing payroll export batch for the selected
                        period. Ensure all adjustments are reviewed before
                        saving changes.
                    </p>
                </div>
                ...
                <form onSubmit={(e) => handleSubmit(e)} className="pb-24">
                    ...
                    <div className="mt-8 flex flex-col-reverse items-center justify-between gap-4 border-t pt-6 pb-4 sm:flex-row">
                        ...
                        <div className="flex w-full items-center gap-3 sm:w-auto">
                            ...
                            <Button
                                type="submit"
                                className="w-full bg-primary px-6 font-bold text-primary-foreground shadow-sm sm:w-auto"
