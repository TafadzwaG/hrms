...
export default function TimesheetEdit() {
    const { record, employees, statusOptions } = usePage<PageProps>().props;
        ...
        <AppLayout
            breadcrumbs={[
                { title: 'Timesheets', href: `${API}/timesheets` },
                {
                    ...
                    href: `${API}/timesheets/${record.id}/edit`,
                },
            ]}
        >
            <Head title={`Edit Timesheet #${record.id}`} />
                ...
                <div className="w-full">
                    <div className="mb-6 flex flex-col gap-1">
                        ...
                        <p className="text-muted-foreground">
                            Update employee working hours and overtime for this
                            timesheet period.
                        </p>
                    </div>
                        ...
                        <div className="space-y-6 lg:col-span-8">
                            <Card className="overflow-hidden border shadow-sm">
                                <CardHeader className="border-b bg-muted/40">
                                    ...
                                    <CardDescription>
                                        Review and update the required
                                        information below.
                                    </CardDescription>
                                </CardHeader>
