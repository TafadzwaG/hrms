...
export default function PositionCreate() {
  const { departments } = usePage().props as any as { departments: Department[] };
  ...
  return (
    <AppLayout
      breadcrumbs={[
        ...
        { title: "Create Position", href: `${API}/positions/create` },
      ]}
    >
        ...
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Add a new job position/title</p>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Enter details for the new position</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div className="space-y-6">
            <Card className="bg-muted/50">
              ...
              <CardContent className="space-y-3 text-sm text-muted-foreground">
                <p><strong>Use codes</strong> if you plan to import positions often (e.g., IT-DEV).</p>
                <p><strong>Department link</strong> helps reporting and filtering.</p>
                <p>Mark unused positions as <strong>Inactive</strong> instead of deleting.</p>
              </CardContent>
            </Card>
          </div>
        </div>
