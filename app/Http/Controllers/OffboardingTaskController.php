...
{
    private const MODULE_KEY = 'offboarding_tasks';
    ...
    public function store(Request $request)
    {
        ...
        OffboardingTask::create($validated);
    ...
    private function validationRules(?Model $record = null): array
    {
        ...
        foreach ($fields as $name => $field) {
            ...
            if (($field['unique'] ?? false) === true) {
                $table = (new OffboardingTask())->getTable();
    ...
    {
        return OffboardingTask::query()->findOrFail($id);
    }
